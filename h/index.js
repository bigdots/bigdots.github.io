	...
	function wordShow(){
		    ...
		    function box(i){
				...
				$('.messages').eq(i).fadeIn(3000, function() {
					showLoveU(i);
			    });
		    }
		  	
		  	
			function showLoveU(z) {
				$('.loveu').eq(z).fadeIn(3000,function(){
					if(z<=3){
						setTimeout(function(){
							$('.loveu').eq(z).fadeOut(2000);
							$('.messages').eq(z).fadeOut(2000);
						},2000)
			...
			var a = setInterval(function(){
			 	if(i > 4){
			 		...
			 		// console.log(3)
			 		$('.messages').eq(i).animate({fontSize:"24px",opacity:"1"},3000);
			 		$('#elapseClock').animate({fontSize:"18px",opacity:"1"},3000);
			 		$('.loveu').eq(i).animate({fontSize:"22px",opacity:"1"},3000);
			 	}else{
			 		// console.log(4)
			 		box(i);
			 	}
